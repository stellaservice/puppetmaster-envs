...
// Lines shortcode config
$ux_shortcodes['height_light'] = array(
	'params' => array(
		'content' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Content','ux'),
			'desc' => __('Please enter the words height-lighted','ux')
		)
	),
	'shortcode' => '[height_light]{{content}}[/height_light]',
	'popup_title' => __('Insert Height-light Shortcode','ux')
);
