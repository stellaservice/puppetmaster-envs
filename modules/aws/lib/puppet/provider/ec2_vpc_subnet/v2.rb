...
Puppet::Type.type(:ec2_vpc_subnet).provide(:v2, :parent => PuppetX::Puppetlabs::Aws) do
  ...
  read_only(:vpc_cidr_block, :vpc, :region, :route_table, :availability_zone, :map_public_ip_on_launch)
  ...
  def self.subnet_to_hash(region, subnet)
...

    {
        ...
        id: subnet.subnet_id,
        vpc_cidr_block: subnet.cidr_block,
  ...
  def create
    ...
    response = ec2.create_subnet(
        vpc_cidr_block: resource[:vpc_cidr_block],
