...
node 'ip-10-108-0-134.bitswarm.internal' inherits default {
  host { $fqdn:
    ip           => $ipaddress,
    host_aliases => ['ip-10-108-0-134', 'ip-10-108-0-134.bitswarm.internal', 'reubenavery-www', 'reubenavery-www.bitswarm.internal']
  }
